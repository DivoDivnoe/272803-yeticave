...
if (isset($_POST['submit']) && !$validate_form) {
    $user_file_post = move_uploaded_image($_FILES['user_file'], 'img');

    if (!$user_file_post['error']) {
...
<?= include_template('templates/add_main.php', [
    'title' => $title_post,
